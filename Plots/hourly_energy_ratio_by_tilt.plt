...
plot "PlotData/hourly_energy_ratio_by_tilt.dat" using 1:2 title "10° Tilt" with lines, \
     "PlotData/hourly_energy_ratio_by_tilt.dat" using 1:3 title "30° Tilt" with lines, \
     "PlotData/hourly_energy_ratio_by_tilt.dat" using 1:4 title "90° Tilt" with lines, \
